...
/**
 * Strings for component 'auth_ws', language 'en'.
 *
 * @package   auth_ws
...
$string['auth_serverurl'] = 'Auth Server URL';
$string['auth_serverurl_desc'] = 'Full URL to webservice to execute the authentication functions';
